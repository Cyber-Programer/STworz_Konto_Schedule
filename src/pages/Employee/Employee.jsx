  ...
  return (
    <div className="p-4">
      <div className="flex  justify-between items-center mb-8">
        <h2 className="text-[2rem] font-semibold leading-[22px] text-textClr">
          Employee
        </h2>
        <button
        ...
        {employees.map((emp) => (
          ...
          >
            ...
            <div className="flex gap-x-3">
              <button className="cursor-pointer text-sm bg-white px-3 py-1 rounded border border-textClr/20">
                Edit
              </button>
              <button
