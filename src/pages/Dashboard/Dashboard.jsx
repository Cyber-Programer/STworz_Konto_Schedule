    ...
    <>
      ...
      <div className="w-full p-4 font-Roboto">
        ...
        <div className="w-full flex justify-between items-center my-4 ">
          <h2 className="text-[2rem] font-semibold font-Roboto text-textClr leading-9.5">Welcome to <br className="hidden md:block" /> Grafik Master</h2>
        ...
        <div className="flex justify-between">
          ...
          <div className="flex gap-2 font-semibold items-center mb-3">
                ...
                <div className="absolute z-10 mt-1 w-full bg-white border border-gray-300 shadow-lg">
                  {options.map((option) => (
                    ...
                    >
                      ...
                      <p className="font-Inter font-medium text-textClr">{option.value}</p>
                    </button>
                  ))}
                </div>
              )}
            ...
            <button className={shOptionsCss}>
              ...
              <p className="hidden lg:block font-Inter font-medium text-textClr">Edit</p>
            </button>
            <button className={shOptionsCss}>
              <img src={WebIcons.scheduleSave} alt="save ico" />
             <p className="hidden lg:block font-Inter font-medium text-textClr"> Save</p>
            </button>
            <button className={shOptionsCss}>
              <img src={WebIcons.scheduleExport} alt="" />
              <p className="hidden lg:block font-Inter font-medium text-textClr">Export to PDF</p>
            </button>
          </div>
        </div>
