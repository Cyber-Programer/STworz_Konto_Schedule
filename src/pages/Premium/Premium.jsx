...
const Premium = () => {
  ...
  return (
    <div className="capitalize font-Roboto mt-5">
      <h1 className="text-[2rem] font-semibold text-textClr">for premium user</h1>
      <div className="m-5 p-10 border border-gray-400 flex flex-col gap-3 items-center justify-center">
        <h1 className="text-2xl sm:text-4xl font-bold capitalize text-center mb-5">subscription plan</h1>
        <div>
          <p className="text-xl text-[#191D23]">choose a plan that's right for you</p>
