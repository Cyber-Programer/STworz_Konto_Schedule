...
//     <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center border border-[#AAAAAA]">
//       <div className=" bg-white p-10 shadow-lg rounded-xl flex flex-col items-center justify-center relative">
//         <h1 className="text-4xl font-bold capitalize mb-14">
//           Subscription Plan
//         </h1>
//         <div className="flex gap-4 font-Roboto">
//           {/* Free */}
//           <div className="free flex flex-col gap-4 w-100 h-140 border-1 border-[#AAAAAA] p-8">
//             <h2 className="font-bold text-[1.735rem] text-[]#191D23">Free</h2>
//             <p className="text-[#64748B]">
//               Ideal for individuals who need quick access to basic features.
//             </p>

//             <div>
//               <span className="  relative w-full block text-5xl font-bold text-[#191D23]">
//                 $0{" "}{" "}
//                  <span className="absolute text-sm ml-2 text-[#4B5768]  bottom-4">
//                   / Month
//                 </span>
//               </span>
//               <button className="capitalize w-full border-1 font-semibold rounded-sm mt-7 text-Primary border-Primary py-2">
//                 get started now
//               </button>
//               <ul className="flex flex-col gap-5 mt-10">
//                 <li className={subscriptionList}>
//                   <img src={WebIcons.subscriptionIco} alt="subico" />
//                   <p className="text-[#191D23] font-medium ">
...
//                 <li className={subscriptionList}>
//                   <img src={WebIcons.subscriptionIco} alt="subico" />
//                   <p className="text-[#191D23] font-medium">Can view the generated schedules</p>
//                 </li>
//                 <li className={subscriptionList}>
//                   <img src={WebIcons.subscriptionIco} alt="subico" />
//                   <p className="text-[#191D23] font-medium">
...
//           </div>
//           {/* Premium */}
//           <div className="bg-Primary text-white p-8 rounded-lg max-w-[417px]">
//             <h2 className="font-bold text-[1.735rem]">Premium</h2>
//             <p className="text-gray-200 font-light w-80">
//               Ideal for individuals who who need advanced features and tools for
//               client work.
//             </p>
//             <span className="relative mt-5  w-full font-Maname  block text-5xl ">
//               199 PLN zt
...
//           </div>
//         </div>
//         <span className="text-Primary absolute top-5 right-10 cursor-pointer">
//           skip
//         </span>
//       </div>
//     </div>
